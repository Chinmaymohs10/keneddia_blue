...
import { getPrimaryConversionsHeader } from "@/Api/RestaurantApi";

// ── Fallback content (shown while loading or if no record found) ──────────────
const FALLBACK = {
  header1:     "Secure Your",
  header2:     "Table.",
    ...
    >
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col lg:flex-row gap-16 items-start">
          ...
          {/* ── RIGHT: parallax glass form (unchanged) ───────────────────── */}
                  ...
                  {currentStep === 2 && (
                    ...
                    >
                      ...
                      <div className="flex gap-4">
                        ...
                        <Button type="button" onClick={handleNext}
                          className="flex-1 h-14 bg-zinc-900 dark:bg-white text-white dark:text-black hover:bg-primary dark:hover:bg-primary hover:text-white transition-all rounded-xl uppercase text-xs font-black">
                          Review Details
                        </Button>
                      </div>
                    </motion.div>
