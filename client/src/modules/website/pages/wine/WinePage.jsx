  ...
  return (
    <>
      ...
      <div className="min-h-screen overflow-x-hidden bg-background">
        <Navbar navItems={WINE_NAV_ITEMS} logo={siteContent.brand.logo_bar} propertyTypeName="Wine" propertyId={bannerPropertyData?.propertyId ?? bannerPropertyData?.id ?? null} />
