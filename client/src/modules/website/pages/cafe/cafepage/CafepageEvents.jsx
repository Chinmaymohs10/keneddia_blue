...
const OFFERS = [
  {
    ...
    description:
      "Fresh croissant, house roast espresso, and a quick breakfast format designed for early-hour guests.",
  ...
  },
  {
    ...
    description:
      "Tea tower service with petit desserts and savouries in a lounge-style format for pairs.",
  ...
  },
  {
    ...
    description:
      "Specialty desserts, cold brews, and artisan toppings available post-dinner for late-hour guests.",
...
const EVENTS = [
  {
    ...
    description:
      "Intimate live sessions paired with curated brews and dessert tastings in the garden.",
  ...
  },
  {
    ...
    description:
      "Interactive cafe sessions focused on pouring techniques, bean origins, and tasting notes.",
  ...
  },
  {
    ...
    description:
      "Live jazz quartet, bottomless cold brews, and a rotating brunch menu every Sunday morning.",
...
const GROUP_BOOKINGS = [
  {
    ...
    description:
      "Pre-set tables, quick service flow, and shared platters for compact office gatherings.",
    image: siteContent.images.cafes.minimalist.src,
  ...
  },
  {
    ...
    description:
      "Birthdays, catch-ups, and cosy celebrations arranged with dessert add-ons.",
    image: siteContent.images.cafes.parisian.src,
  ...
  },
  {
    ...
    description:
      "Curated tasting menus and private seating for team outings and client meetings.",
    image: siteContent.images.cafes.library.src,
          ...
          >
            <div className="flex items-center gap-3 p-3">
              ...
              <Link to={`/cafe/group/${item.slug}`}>
                <Button type="button" size="icon" className="h-9 w-9 shrink-0 rounded-full">
