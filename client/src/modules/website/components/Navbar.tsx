...
type QuickBookOption =
  | { label: string; category: "hotel" | "dining" | "delivery" | "restaurant" | "cafe"; href?: never }
...
export default function Navbar({
  ...
  return (
    <nav className={`${navbarClasses} site-nav-shell`}>
      ...
      <CafeBookingSheet
        isOpen={cafeBookingOpen}
        onOpenChange={setCafeBookingOpen}
      />
    </nav>
  );
}
