...
function OurPresence() {
    ...
    try {
      ...
      if (response?.data) {
        ...
        setSectionData({
          ...
          mainHeading:
            response.data.sectionSubtitle || "Luxury Hospitality Across India",
  ...
  const handleTileChange = (id, field, value) => {
    setFeatureTiles(
      featureTiles.map((t) => (t.id === id ? { ...t, [field]: value } : t)),
    );
  };
        ...
        <div className="space-y-3">
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                handleSectionChange("overlineText", e.target.value)
              }
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                handleSectionChange("mainHeading", e.target.value)
              }
              className="w-full px-3 py-2 rounded border text-sm"
              style={{
                borderColor: colors.border,
          ...
          <div>
            ...
            <label className="flex items-center gap-2 cursor-pointer">
              <input
                ...
                onChange={(e) =>
                  handleSectionChange("isActive", e.target.checked)
                }
      ...
      >
        ...
        <div className="space-y-3">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-3">
                  <div>
                    ...
                    <input
                      ...
                      value={tile.title}
                      onChange={(e) =>
                        handleTileChange(tile.id, "title", e.target.value)
                      }
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleTileChange(tile.id, "description", e.target.value)
                      }
                      className="w-full px-2.5 py-1.5 rounded border text-sm"
                      style={{
                        borderColor: colors.border,
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        handleTileChange(tile.id, "icon", e.target.value)
                      }
                      className="w-full px-2.5 py-1.5 rounded border text-sm"
                      style={{
                        borderColor: colors.border,
          ...
          {featureTiles.length === 0 && (
            ...
            >
              <p className="text-sm">
                No feature tiles added yet. Click "Add Tile" to create one.
              </p>
            </div>
          )}
        </div>
