...
export const getUsersPaginated = ({
  ...
  API.get("api/v1/users/auth/paginated", {
    params: { lastId, size, direction, includeInactive },
  });
...
export const updatePropertyType = (id, data) =>
  API.put(`api/v1/property-types/${id}`, data);
...
export const updatePropertyCategory = (id, data) =>
  API.put(`api/v1/property-categories/update/${id}`, data);
...
export const addGuestExperineceRatingHeader = (data) =>
  API.post("/api/v1/ratings", data);
export const EditGuestExperineceRatingHeader = (id, data) =>
  API.put(`/api/v1/ratings/${id}`, data);
export const getGuestExperineceRatingHeader = (id) =>
...
export const toggleHeroSectionMobile = (id, show) =>
  API.patch(`api/v1/hero-sections/${id}/mobile`, null, { params: { show } });
...
export const getAllGalleries = ({ page = 0, size = 100 }) =>
  API.get("api/v1/gallery/showAll", { params: { page, size } });
export const getGalleryById = (id) => API.get(`api/v1/gallery/${id}`);
export const getGalleryByPropertyId = (propertyId) =>
  API.get(`api/v1/gallery/property/${propertyId}`);
...
// Add Group Booking
export const addGroupBooking = (data) =>
  API.post("/api/v1/group-bookings", data);
export const updateGroupBooking = (id, data) =>
  API.put(`/api/v1/group-bookings/${id}`, data);
...
export const addCommentReply = (data) =>
  API.post("api/v1/comments/admin/reply", data);
// get entire comment thread by comment id
export const getCommentThread = (commentId) =>
  API.get(`api/v1/comments/${commentId}`);
// get comments by property id
export const getCommentsByProperty = (propertyId) =>
  API.get(`api/v1/comments/property/${propertyId}`);
// get comments by property type id
export const getCommentsByPropertyType = (propertyTypeId) =>
  API.get(`api/v1/comments/property-type/${propertyTypeId}`);
// get comments by news id
export const getCommentsByNews = (newsId) =>
  API.get(`api/v1/comments/news/${newsId}`);
// delete comment (hard delete with replies)
export const deleteComment = (commentId) =>
  API.delete(`api/v1/comments/${commentId}`);
// toggle main comment enable/disable
export const toggleCommentStatus = (data) =>
  API.put("api/v1/comments/admin/toggle-status", data);
// toggle reply enable/disable
export const toggleCommentReplyStatus = (replyId) =>
  API.put(`api/v1/comments/admin/toggle-reply-status/${replyId}`);

//Event-extra data and post event images api's
export const uploadEventGallery = (formData) =>
  API.post("api/v1/event-gallery-upload/upload", formData, {
    headers: { "Content-Type": "multipart/form-data" },
  });
export const getAllUploadedEventFiles = (formData) =>
  API.get("api/v1/event-gallery-upload/getAllUploadedFiles", {
    data: formData,
  });
export const getEventFilesByUploadedId = (id) =>
  API.get(`api/v1/event-gallery-upload/getGalleryEventUploadsByEventId/${id}`);
...
// ─────────────────────────────
export const addEventDetailInfo = (formData) =>
  API.post("api/v1/event-card/addCard", formData, {
    headers: { "Content-Type": "multipart/form-data" },
  });
export const getEventDetailInfo = () => API.get("api/v1/event-card/getCards");
export const getEventDetailInfoById = (id) =>
  API.get(`api/v1/event-card/getCardsByEventId/${id}`);
export const updateEventDetailInfo = (id, formData) =>
  API.patch(`api/v1/event-card/updateCard/${id}`, formData, {
    headers: { "Content-Type": "multipart/form-data" },
  });
...
export const addEventInterest = (data) =>
  API.post("api/v1/book-interested/addInterest", data);
export const addEventBooking = (data) =>
  API.post("api/v1/book-interested/addBookNow", data);
export const getEventInterestByEventId = (eventId) =>
  API.get(`api/v1/book-interested/getByEventId/${eventId}`);
export const getBookByEventId = (eventId) =>
  API.get(`api/v1/book-interested/getBookByEventId/${eventId}`);
export const getBookInterestedById = (id) =>
  API.get(`api/v1/book-interested/getByBookInterestedId/${id}`);

//hotel dining section
// ================= DINING APIs =================

// CREATE Dining
export const createDining = (formData) =>
  API.post("api/v1/dining/createDining", formData);
// GET all Dining
export const getAllDining = () => API.get("api/v1/dining/getAllDining");
// GET Dining by Property ID
export const getAllDiningByPropertyId = (propertyId) =>
  API.get(`api/v1/dining/getAllDiningByPropertyId/${propertyId}`);
// TOGGLE Dining (Active/Inactive + update fields)
export const toggleDining = (id, formData) =>
  API.patch(`api/v1/dining/toggle/${id}`, formData);
// UPDATE Dining
export const updateDining = (id, formData) =>
  API.put(`api/v1/dining/updateDining/${id}`, formData);

// ================= BOOKING CHANNEL PARTNER APIs =================

// CREATE
export const createBookingChannelPartner = (data) =>
  API.post("api/v1/booking-channel-partners", data);
// GET ALL
export const getAllBookingChannelPartners = () =>
  API.get("api/v1/booking-channel-partners");
// GET BY PROPERTY
export const getBookingChannelPartnersByPropertyId = (propertyId) =>
  API.get(`api/v1/booking-channel-partners/property/${propertyId}`);
// UPDATE
export const updateBookingChannelPartner = (id, data) =>
  API.put(`api/v1/booking-channel-partners/${id}`, data);
// TOGGLE STATUS (Active / Inactive)
export const updateBookingChannelPartnerStatus = (id, isActive) =>
  API.patch(`api/v1/booking-channel-partners/${id}/status`, null, {
    params: { isActive },
  });

//SEO API'S
export const addGoogleTag = (data) =>
  API.post("api/v1/google-tag/addGoogleTag", data);
export const getAllGoogleTags = () =>
  API.get("api/v1/google-tag/getAllGoogleTag");
export const getAllActiveGoogleTags = () =>
  API.get("api/v1/google-tag/getAllActiveGoogleTag");
export const getGoogleTagById = (id) =>
  API.get(`api/v1/google-tag/getGoogleTagById/${id}`);
export const updateGoogleTag = (id, data) =>
  API.patch(`api/v1/google-tag/updateGoogleTag/${id}`, data);
export const deleteGoogleTag = (id) =>
  API.delete(`api/v1/google-tag/deleteGoogleTag/${id}`);
// ----------------
// ================= META DATA APIs =================

export const addMetaData = (data) =>
  API.post("api/v1/meta-data/addMetaData", data);
// GET all Meta Data
export const getAllMetaData = () => API.get("api/v1/meta-data/getAllMetaData");
export const getAllActiveMetaData = () =>
  API.get("api/v1/meta-data/getAllActiveMetaData");
export const getMetaDataById = (id) =>
  API.get(`api/v1/meta-data/getMetaDataById/${id}`);
export const updateMetaData = (id, data) =>
  API.patch(`api/v1/meta-data/updateMetaData/${id}`, data);
export const toggleMetaDataById = (id) =>
  API.patch(`api/v1/meta-data/toggleMetaDataById/${id}`);
export const deleteMetaData = (id) =>
  API.delete(`api/v1/meta-data/deleteMetaData/${id}`);
